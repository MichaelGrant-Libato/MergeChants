...
// --- Dummy Data ---
const CARD_COLOR = "#8D0133"; // Primary Card Background Color
...
const DUMMY_PRODUCTS = [
  ...
  { id: 6, name: "Lamp", subTitle: "Desk Lamp - LED", category: "Furniture", price: 15, originalPrice: 35, condition: "Good", rating: 4.5, reviews: 23, seller: "StudySpace", campus: "Dorm Area", tags: [], time: "6h ago", color: CARD_COLOR, style: "Good" },
];
...
const ProductCard = ({ product }) => (
    <div className="product-card">
        <div className="card-header" style={{ backgroundColor: CARD_COLOR }}> 
            ...
            {product.tags.includes('Verified') && <span className="verified-badge">✓ Verified</span>}
...
export default function Dashboard() {
    ...
    const conditions = ["All Conditions", "New", "Like New", "Excellent", "Very Good", "Good"];
        ...
        <div className="dashboard-container">
            ...
            <header className="dashboard-header">
                <div className="logo">
                    ...
                    <span className="logo-text"><span className="merge-color">Merge</span>Chants</span>
                </div>
                ...
                <nav className="header-nav">
                    <a href="#marketplace" className="nav-item active">Marketplace</a>
                    <a href="#mylistings" className="nav-item">My Listings</a>
                    <a href="#messages" className="nav-item">Messages</a>
                    <a href="#sell" className="nav-item">Sell Item</a>
                    <a href="#history" className="nav-item">History</a>
                    <a href="#report" className="nav-item">Report</a>
                </nav>
                ...
                <aside className="sidebar">
                    ...
                    <div className="filter-section">
                        ...
                        <div className="price-inputs">
                            <span className="price-label min-label">${priceRange.min}</span>
                            <span className="price-label max-label">${priceRange.max}</span>
                        </div>
